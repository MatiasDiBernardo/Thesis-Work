...
{\color{red}FALTA: Explicar porque necesito hacer lo del modelo de estimación de densidad.}

\subsubsection{Validación con medelo zero-shot}
{\color{red}FALTA: Definir modelo y explicar la justificación de este experimento.}
