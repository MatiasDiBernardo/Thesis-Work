...
\begin{figure}[h]
  \centering
  \centerline{\includegraphics[width=13cm]{Figuras/Desarrollo/mos_pred_dist.pdf}}
...
Tamaño de lote (\textit{Batch size})   & 16 muestras por GPU \\
