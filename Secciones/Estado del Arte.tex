...
\begin{itemize}
    \item Modelos autoregresivos: Tacotron2, DurIAN, FastSpeech2.
    \item Modelos no autoregresivos: VITS, GradTTS, F5 TTS.
    \item Modelos basados en difusión: Diff-TTS, ProDiff, DiffSpeech.
