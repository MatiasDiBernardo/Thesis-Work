...
{\color{red}FALTA: Variar los pesos que se le da a cada métrica para que el desvío quede igual y analizar como queda el ranking de la mejor configuración con este ajuste.}
...
{\color{red}FALTA: Continuar el análisis para cada métrica y hacer conclusión general de esta comparación.}
