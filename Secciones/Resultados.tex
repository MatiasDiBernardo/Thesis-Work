...
\subsubsection{Análisis de calidad datasets profesionales}
{\color{red}FALTA: Hacer una tabla de los resultados de cada subdataset que lleva a la métrica total representativa de un dataset profesional.}

\subsubsection{Dataset profesional vs procesado}
Del valor global obtenido como referencia al evaluar diferentes conjuntos de datos profesionales (descrito en la Sección 4.1.2), se llega a un valor representativo del estándar de calidad que se utiliza en la confección de datos de máxima calidad. En la Figura \ref{fig:pro_vs_p_PESQ} se compara el resultado de PESQ para la condición base, el peor y mejor resultado de la cadena, y el valor promedio de los dataset profesionales. Esto pretende mostrar que si bien se genera una mejora objetiva en el dataset original, simplemente con procesamiento no se pueden igualar las condiciones de un conjunto de datos grabado en condiciones óptimas. 
