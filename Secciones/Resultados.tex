...
\begin{figure}[h]
  \centering
  \centerline{\includegraphics[width=15cm]{Figuras/Pro_vs_Pipe/pro_vs_pipe_PESQ.png}}
  \caption{Diferencias del valor de PESQ promedio según diferentes conjuntos de datos.}
    \label{fig:pro_vs_p_PESQ}
\end{figure}

En cambio, para el parámetro de $T_{30}$, se observa que la mejor variante con procesamientos mejora la condición de reverberancia promedio alcanzada por el promedio de dataset tradicionales Figura \ref{fig:pro_vs_p_T30}. Esto deja en evidencia que la variación producto del procesamiento depende específicamente de cada métrica, donde se puede evaluar casos como el PESQ donde no se iguala el valor del dataset original, o casos como el $T_{30}$ donde se mejora la condición de referencia.

{\color{red}FALTA: Rehacer estos gráficos y agregar desvío, pueden ser box plot también, tengo que evaluar que queda mejor.}

\begin{figure}[h]
  \centering
  \centerline{\includegraphics[width=15cm]{Figuras/Pro_vs_Pipe/pro_vs_pipe_T30.png}}
  \caption{Diferencias del valor de T30 promedio según diferentes conjuntos de datos.}
    \label{fig:pro_vs_p_T30}
\end{figure}

{\color{red}FALTA: Continuar el análisis para cada métrica y hacer conclusión general de esta comparación (hacer tabla general de esta comparación y determinar si hablo en concreto de alguna métrica más o pongo el resultado general y listo).}
