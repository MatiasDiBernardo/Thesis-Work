...
{\color{red}FALTA: Variar los pesos que se le da a cada métrica para que el desvío quede igual y analizar como queda el ranking de la mejor configuración con este ajuste (a esta altura me parece agregar un layer más de complejidad que no se si suma mucho, lo dejaría para trabajos futuros).}
...
{\color{red}FALTA: Agregar en el anexo los gráficos que faltan de esta sección.}
...
Para esta validación, se seleccionaron las mimas 8 configuraciones que se seleccionaron para el modelo de estimación de densidad, con el objetivo de comparar los resultados obtenidos por el modelo de difusión con los resultados de MOS obtenidos al evaluar los modelos de TTS zero-shot.

{\color{red}FALTA: Compara calidad de clonación respecto a la calidad o subset del audio original.}
Para minimizar los tiempos de evaluación de esta prueba, se tomaron 100 audios de forma aleatorio de cada variante de la cadena, y se utilizaron como referencia para el modelo de TTS zero-shot. La elección de tomar esta cantidad de muestras se debe a las limitaciones de infraestructura para poder escalar el experimento. 

\begin{itemize}
  \item Presentar gráficos de MOS vs Metricas compuestas 
  \item Presentar gráficos de MOS vs estimación densidad 
  \item Concluir cual es la mejor métrica según análisis subjetivo 
\end{itemize}


\subsection{EVALUACIÓN EXPLORATORIA EN TAREAS DE SÍNTESIS ZERO-SHOT}
A continuación, se presentan los resultados comparativos entre la capacidad predictiva de las métricas objetivas (TOT) y la estimación de densidad (Log-Likelihood) frente a la calidad del habla sintetizada.
...
\subsubsection{Sensibilidad Arquitectónica: Modelos Autoregresivos frente a Modelos de Difusión}
