...
{\color{red}FALTA: Comparar entre conjuntos de datos profesionales vs datos ITW (por estimación de densidad).}

El modelo de predicción de densidad data driven, permite ordenar las diferentes variantes de la cadena de procesamiento según su similitud acústica y estadística con el corpus profesional, donde el criterio es basa en la capacidad de los modelos de difusión para estimar la verosimilitud al aprender la distribución intrínseca de los datos. Bajo la hipótesis de que una mayor verosimilitud indica una mayor cercanía a la distribución de calidad profesional, este método permite evaluar objetivamente qué configuración logra preservar mejor las características deseables de la señal, sin necesidad de recurrir a métricas objetivas específicas o evaluaciones subjetivas.
...
\begin{itemize}
  \item Presentar tabla con el promedio y desvío de similaridad de cada configuración de la cadena
\end{itemize}

\subsection{COMPARACIÓN ENTRE MÉTRICAS OBJETIVAS Y ESTIMACIÓN DE DENSIDAD}

\begin{itemize}
  \item Comparar el orden de la versión por estimación de densidad vs el orden por métricas objetivas
\end{itemize}
