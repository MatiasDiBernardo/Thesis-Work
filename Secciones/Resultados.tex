...
Cabe aclarar que la métrica por estimación de densidad no contempla la reducción de datos que si contempla el resultado total de las métricas objetivas, pero al analizar la tendencia solo con los valores de calidad de señal (CS) y condiciones acústicas (CA), se observa que la tendencia es la misma, Demucs obtiene los mejores resultados en comparación a DeepFilterNet.
