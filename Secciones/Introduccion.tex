...
Esta tesis corresponde a una investigación de carácter tecnológico orientada al desarrollo y evaluación de una herramienta de software para la selección automática de audios, destinada a la generación de conjuntos de datos de habla. Validar este tipo de herramientas, es fundamental para crear un dataset en español con los diferentes acentos de Argentina, contribuyendo al avance de las tecnologías del habla en el país y, en consecuencia, a la soberanía tecnológica nacional.

El desarrollo de esta tesis se enmarca en el proyecto Archivoz del grupo de investigación Intercambios Transorgánicos, radicado en el MUNTREF. El proyecto Archivoz comenzó en 2019 liderado por la Lic. Gala Lucía Gonzales Barrios, se centra en la investigación de tecnologías del habla y sus aplicaciones en el campo de la salud, principalmente enfocado en pacientes que perdieron la capacidad de hablar como es el caso de personas que sufrieron una laringectomía. La investigación de este proyecto se orienta a la creación de sistemas de TTS que permitan a los pacientes recuperar la capacidad de comunicarse mediante la síntesis de su propia voz, utilizando para ello modelos de clonación de voz y técnicas de aprendizaje profundo.
